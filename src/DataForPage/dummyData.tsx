import chair from '../images/chairPurple.png';
import sofa2 from '../images/roseChair.png';
import sofa3 from '../images/gray-chair.png';
import phone1 from '../images/bedRoom.png';
import phone2 from '../images/MidComponentPhone.png';
import blueSofa from '../images/blueSofa.png';

export const navbarData: NavvarType = [
  {
    id: '1',
    name: 'News',
    link: 'news',
...
export const tabsData = [
  ...
  },
  {
    ...
    label: 'LivingRoom',
    value: 'livingroom',
    desc: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Reiciendis quas iste excepturi repellat est explicabo, aut dicta facilis? Cupiditate, ea.',
    img: phone2,
    linkText: 'See more',
  },
